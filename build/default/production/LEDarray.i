...
void LEDarray_disp_bin(volatile int number)
{
    ...
    if((number>>1) & 1) {LATGbits.LATG1 = 1;} else {LATGbits.LATG1 = 0;}
    if((number>>2) & 1) {LATAbits.LATA2 = 1;} else {LATAbits.LATA2 = 0;}
    if((number>>3) & 1) {LATFbits.LATF6 = 1;} else {LATFbits.LATF6 = 0;}
    if((number>>4) & 1) {LATAbits.LATA4 = 1;} else {LATAbits.LATA4 = 0;}
    if((number>>5) & 1) {LATAbits.LATA5 = 1;} else {LATAbits.LATA5 = 0;}
    if((number>>6) & 1) {LATFbits.LATF0 = 1;} else {LATFbits.LATF0 = 0;}
    if((number>>7) & 1) {LATBbits.LATB0 = 1;} else {LATBbits.LATB0 = 0;}
    if((number>>8) & 1) {LATBbits.LATB1 = 1;} else {LATBbits.LATB1 = 0;}
}
